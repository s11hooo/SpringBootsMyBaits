...
public class MailController {
    ...
    public MsgDTO sendMail(HttpServletRequest request) {
        ...
        // 웹 URL로부터 전달받는 값들
        String toMail = CmmUtill.nvl(request.getParameter("toMail"));      // 받는사람
        String title = CmmUtill.nvl(request.getParameter("title"));        // 제목
        String contents = CmmUtill.nvl(request.getParameter("contents"));  // 내용
