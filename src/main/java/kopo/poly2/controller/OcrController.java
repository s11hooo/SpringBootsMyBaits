...
import kopo.poly2.utill.FileUtill;
...
public class OcrController {
    ...
    public String readImage(ModelMap model, @RequestParam(value = "fileUpload") MultipartFile mf) throws Exception {
        ...
        if (ext.equals("jpeg") || ext.equals("jpg") || ext.equals("gif") || ext.equals("png")) {
            ...
            String saveFileName = DateUtill.getDateTime("HHmmss") + "." + ext;

            // 웹서버에 업로드한 파일이 저장되는 물리적 경로
            String saveFilePath = FileUtill.mkdirForDate(FILE_UPLOAD_SAVE_PATH);
            ...
            res = CmmUtill.nvl(rDTO.getTextFromImage()); // 인식 결과
